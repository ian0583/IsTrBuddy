...
class Core_ACL
{
	...
	/**
     * Authenticates using the given username and password and processes the user's permissions
     *
	...
	/**
     * Checks if the signed in user is allowed to access the given module and access level
     *
     * @param int $moduleid
