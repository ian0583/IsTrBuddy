...
class Core_Task
{
	...
	/**
	 * Class Constructor that sets the task parameters, name and starting timestamp
	 *
	...
	/**
	 * Logs a message into the task log file and optionally outputs the message to the command-line
	 *
	...
	/**
	 * Class destructor that computes the total runtime for the script and logs the task execution into the task log file
	 *
	 */
